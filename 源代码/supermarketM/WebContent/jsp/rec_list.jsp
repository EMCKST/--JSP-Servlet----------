	...
	<nav class="navbar navbar-default header navbar-fixed-top">
		<div class="col-md-12 nav-wrapper">
			<div class="navbar-header" style="width: 100%;">
				...
				<a href="index.html" class="navbar-brand"> <b>商品统计</b>
				</a>
						...
						<ul class="nav nav-list tree">
							...
							<c:choose>
								<c:when test="${USER.roleId == 1}">
									...
									<li><a
										href="${pageContext.request.contextPath }/sell/sell-list">商品统计</a></li>
									<li><a
		...
		<div id="content">
			<div class="panel">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="animated fadeInLeft">商品统计</h3>
						<p class="animated fadeInDown">
							业务 <span class="fa-angle-right fa"></span> 商品统计
						</p>
					</div>
				</div>
			</div>
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc"
																style="width: 40px; text-align: center;">统计编号</th>
															<th class="sorting"
																style="width: 400px; text-align: center;">统计详情</th>
														</tr>
													</thead>
													<tbody>
														<c:forEach items="${LIST }" var="list">
															<tr role="row" class="odd">
																...
																<td style="text-align: center">${list.rec }</td>
															</tr>
														</c:forEach>
													</tbody>
												</table>
