	...
	<nav class="navbar navbar-default header navbar-fixed-top">
		<div class="col-md-12 nav-wrapper">
			<div class="navbar-header" style="width: 100%;">
				...
				<a href="#" class="navbar-brand"> <b>修改商品详情</b>
				</a>
		...
		<div id="content">
			<div class="panel">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="animated fadeInLeft">修改商品详情</h3>
						<p class="animated fadeInDown">
							业务 <span class="fa-angle-right fa"></span> 修改商品详情
						</p>
					</div>
				</div>
			</div>
			<div class="form-element">
				<div class="col-md-12 padding-0">
					<div class="col-md-12">
						<form
							action="${pageContext.request.contextPath }/goods/update-goods"
							method="post">
							...
							<div class="panel form-element-padding">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="name"
											readonly="readonly" value="${UPDATEGOODS.name }">
									</div>
									<label class="col-sm-1 control-label text-right">产地</label>
									<div class="col-sm-3">
										<input type="text" class="form-control" name="address"
											value="${UPDATEGOODS.address }">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="qpg"
											value="${UPDATEGOODS.qpg }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control" name="supplier"
											value="${UPDATEGOODS.supplier }">
									</div>
									<label class="col-sm-1 control-label text-right">备注</label>
									<div class="col-sm-3">
										<textarea rows="2" cols="15" class="form-control" name="rema">${UPDATEGOODS.rema }</textarea>
									</div>

									<div class="form-group">

										<!-- id -->
										<input name="id" type="hidden" value="${UPDATEGOODS.id }" />
									</div>
