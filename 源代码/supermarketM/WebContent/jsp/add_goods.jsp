	...
	<nav class="navbar navbar-default header navbar-fixed-top">
		<div class="col-md-12 nav-wrapper">
			<div class="navbar-header" style="width: 100%;">
				...
				<a href="#" class="navbar-brand"> <b>添加商品</b>
				</a>
		...
		<div id="content">
			<div class="panel">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="animated fadeInLeft">添加商品</h3>
						<p class="animated fadeInDown">
							业务 <span class="fa-angle-right fa"></span> 添加商品
						</p>
					</div>
				</div>
			</div>
			<div class="form-element">
				<div class="col-md-12 padding-0">
					<div class="col-md-12">
						<form action="${pageContext.request.contextPath }/goods/add-goods"
							method="post">
