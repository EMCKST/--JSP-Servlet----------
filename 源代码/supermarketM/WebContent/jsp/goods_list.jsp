	...
	<nav class="navbar navbar-default header navbar-fixed-top">
		<div class="col-md-12 nav-wrapper">
			<div class="navbar-header" style="width: 100%;">
				...
				<a href="index.html" class="navbar-brand"> <b>商品清单</b>
				</a>
		...
		<div id="content">
			<div class="panel">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="animated fadeInLeft">商品清单</h3>
						<p class="animated fadeInDown">
							业务 <span class="fa-angle-right fa"></span> 商品清单
						</p>
					</div>
				</div>
			</div>
						...
						<div class="panel">
							<div class="panel-heading">
								...
								<button class="btn btn-primary btn-sm" data-toggle="modal"
									style="margin-left: 970px;" data-target="#myModal">
									<a style="color: white;"
										href="${pageContext.request.contextPath }/jsp/add_goods.jsp">添加</a>
								</button>
								</h4>
							</div>
							<div class="panel-body">
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc"
																style="width: 50px; text-align: center;">商品编号</th>
															<th class="sorting"
																style="width: 100px; text-align: center;">商品名称</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">产地</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">规格</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">商标</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">进价</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">批发价</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">零售价</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">保质期</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">修改</th>
															<th class="sorting"
																style="width: 40px; text-align: center;">查看详情</th>
														</tr>
													</thead>
													<tbody>
														<c:forEach items="${LIST }" var="list">
															<tr role="row" class="odd">
																...
																<td style="text-align: center">${list.spec }</td>
																<td style="text-align: center">${list.trademark }</td>
																<td style="text-align: center">${list.p_price }</td>
																<td style="text-align: center">${list.t_price }</td>
																<td style="text-align: center">${list.price }</td>
																<td style="text-align: center">${list.qpg }</td>

																<td style="text-align: center"><button
																		class="btn btn-primary btn-sm" data-toggle="modal"
																		data-target="#myModal">
																		<a style="color: white"
																			href="${pageContext.request.contextPath }/goods/toUpdate-goods?id=${list.id}">修改</a>
																	</button></td>
																...
																<td style="text-align: center"><button
																		...
																		data-target="#myModal">
																		<a style="color: white"
																			href="${pageContext.request.contextPath }/goods/details?id=${list.id}">查看</a>
																	</button></td>
