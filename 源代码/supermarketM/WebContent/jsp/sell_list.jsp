	...
	<nav class="navbar navbar-default header navbar-fixed-top">
		<div class="col-md-12 nav-wrapper">
			<div class="navbar-header" style="width: 100%;">
				...
				<a href="index.html" class="navbar-brand"> <b>商品出售</b>
				</a>
		...
		<div id="content">
			<div class="panel">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="animated fadeInLeft">商品出售</h3>
						<p class="animated fadeInDown">
							业务 <span class="fa-angle-right fa"></span> 商品出售
						</p>
					</div>
				</div>
			</div>
												...
												<table
													...
													<thead>
														<tr role="row">
															...
															<th class="sorting"
																style="width: 60px; text-align: center;">库存</th>
															<th class="sorting"
																style="width: 60px; text-align: center;">出售</th>
														</tr>
													</thead>
													<tbody>
														<c:forEach items="${QUERYGOODS }" var="list">
															<tr role="row" class="odd">
																...
																<c:forEach items="${QUERYWARE }" var="list2">
																	<c:if test="${list.name == list2.g_name }">
																		<td style="text-align: center">${list2.stock }</td>
																		<td style="text-align: center"><button
																				class="btn btn-primary btn-sm" data-toggle="modal"
																				data-target="#myModal">
																				<a style="color: white"
																					href="${pageContext.request.contextPath }/sell/update-sell?id=${list2.id}&stock=${list2.stock }&username=${USER.username }&g_name=${list2.g_name } ">出售</a>
																			</button></td>
																	</c:if>
																</c:forEach>
															</tr>
